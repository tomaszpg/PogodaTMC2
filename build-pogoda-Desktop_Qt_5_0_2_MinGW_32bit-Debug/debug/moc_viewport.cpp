...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Viewport_t, stringdata) + ofs \
...
void Viewport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Viewport::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Viewport::refresh)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Viewport::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Viewport.data,
